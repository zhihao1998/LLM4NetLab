...
class BGPAsnMisconfigLocalization(BGPAsnMisconfigBase, LocalizationTask):
    ...
    SUBMISSION = LocalizationSubmission(
        faulty_devices=[BGPAsnMisconfigBase.faulty_router],
    )
...
class BGPMissingAdvertiseLocalization(BGPMissingAdvertiseBase, LocalizationTask):
    ...
    SUBMISSION = LocalizationSubmission(
        faulty_devices=[BGPMissingAdvertiseBase.faulty_router],
    )
...
class StaticBlackHoleLocalization(StaticBlackHoleBase, LocalizationTask):
    ...
    SUBMISSION = LocalizationSubmission(
        faulty_devices=[StaticBlackHoleBase.target_device],
    )
...
class BGPBlackholeRouteLeakDetection(BGPBlackholeRouteLeak, DetectionTask):
    META = ProblemMeta(
        root_cause_category=BGPBlackholeRouteLeak.ROOT_CAUSE_CATEGORY,
        root_cause_name=BGPBlackholeRouteLeak.ROOT_CAUSE_NAME,
        task_level=TaskLevel.DETECTION,
        description=TaskDescription.DETECTION,
    )
...
class BGPBlackholeRouteLeakLocalization(BGPBlackholeRouteLeak, LocalizationTask):
    META = ProblemMeta(
        root_cause_category=BGPBlackholeRouteLeak.ROOT_CAUSE_CATEGORY,
        root_cause_name=BGPBlackholeRouteLeak.ROOT_CAUSE_NAME,
        task_level=TaskLevel.LOCALIZATION,
    ...
    SUBMISSION = LocalizationSubmission(
        faulty_devices=[BGPBlackholeRouteLeak.target_device],
    )
...
class BGPBlackholeRouteLeakRCA(BGPBlackholeRouteLeak, LocalizationTask):
    META = ProblemMeta(
        root_cause_category=BGPBlackholeRouteLeak.ROOT_CAUSE_CATEGORY,
        root_cause_name=BGPBlackholeRouteLeak.ROOT_CAUSE_NAME,
        task_level=TaskLevel.RCA,
