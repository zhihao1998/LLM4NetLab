...
class SimpleSwitchThriftAPI(thrift_API.ThriftAPI):
    ...
    def __init__(self, thrift_port, thrift_ip="localhost", json_path=None):
        ...
        super().__init__(thrift_port, thrift_ip, pre_type, json_path)

        self.sswitch_client = thrift_API.thrift_connect(
            thrift_ip, thrift_port, SimpleSwitchThriftAPI.get_thrift_services()
        )[0]
