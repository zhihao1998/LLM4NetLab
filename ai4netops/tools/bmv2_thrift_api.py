...
from p4utils.utils.thrift_API import ResType, hexstr, MatchType, BmActionEntryType
...
class Bmv2ThriftAPI:
    ...
    def dump_one_entry(self, table, entry):
        ...
        if entry.action_entry.action_type == BmActionEntryType.ACTION_DATA: # only consider simple entries with action data
