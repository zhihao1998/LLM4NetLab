...
control process_int_transit (
    ...
    action int_set_header_3() { //q_occupancy
        // TODO: Support egress queue ID, not support in bmv2
    ...
    // TODO: In INT spec 2.0, this filed is 8 bytes
    @hidden
    ...
    action int_set_header_7() { //egress_port_tx_utilization
        ...
        hdr.int_egress_tx_util.egress_port_tx_util = (bit<32>) 0;
        // (bit<32>) queueing_metadata./-;
